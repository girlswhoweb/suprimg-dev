...
const ShopPage = () => {
  ...
  // The skeleton will be rendered by the Suspense fallback in App.jsx
  if (fetching || loading || !appSettings) {
    return null;
  }
  ...
  return (
    ...
    >
      ...
      <Frame>
        <div className={`cls-loading-wrapper ${!loading && appSettings ? 'loaded' : ''}`} style={(loading || !appSettings) ? { opacity: 0.5, pointerEvents: "none" } : { opacity: 1 }}>
          <div className="cls-container">
            <Layout>
              {/* Header Section - Reserve space for banners */}
